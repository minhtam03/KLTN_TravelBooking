...
//       // Fetch bookings
//       const resBookings = await fetch(`${BASE_URL}/booking/tour/all`, {
//         method: 'GET',
//         credentials: 'include',
//       });
...
const TourDetails = () => {
  ...
  const updateSummary = async () => {
    try {
      const { data } = await axios.get(`${BASE_URL}/review/summary/${id}`);
  ...
  // Gán reviews vào state riêng khi tour load xong
  useEffect(() => {
    if (tour && reviews) {
      setReviewList(reviews);
      updateSummary(); // chỉ gọi khi load lần đầu
    }
  }, [tour]);
            ...
            <Col lg="8">
              <div className="tour__content">
                ...
                <div className="tour__info">
                  ...
                  <div className="d-flex align-items-center gap-5">
                    <span className="tour__rating d-flex align-items-center gap-1">
                      <i className="ri-star-fill" style={{ color: 'var(--secondary-color)' }}></i>
                      {avgRating === 0 ? null : avgRating}
                      {reviewList.length === 0 ? 'Not rated' : <span>({reviewList.length})</span>}
                    </span>
                  ...
                  <div className="tour__extra-details">
                    ...
                    <span><i className="ri-pin-distance-line"></i> {distance} km</span>
                ...
                <div className="tour__reviews mt-4">
                  ...
                  <Form onSubmit={submitHandler}>
                    <RatingStars current={tourRating} onRate={setTourRating} />
                    <div className="review__input">
